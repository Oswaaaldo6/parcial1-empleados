...
if checkbox_datos:
  estado = st.text('Cargando información')
  data = cargar_data(500)  
...
inputID = st.sidebar.text_input('ID: ')
btnFiltrarId = sidebar.button('Buscar ID')

inputCiudadNatal = st.sidebar.text_input('Ciudad: ')
btnFiltrarCiudadNatal = sidebar.button('Buscar ciudad')

inputTrabajo = st.sidebar.text_input('Unidad de trabajo: ')
